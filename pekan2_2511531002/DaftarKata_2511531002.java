...
public class DaftarKata_2511531002 {
	private final ArrayList<String> data;
	// Konstruktor: inisialisasi list kosong
	public DaftarKata_2511531002() {
		this.data = new ArrayList<>();
	}
	/** Menambahkan elemen di akhir list. */
	public void tambah_2511531002(String elemen) {
		data.add(elemen);
	}
	/** Menambahkan elemen pada indeks tertentu (menyisipkan). */
	public void tambahPada_2511531002(int index, String elemen) {
	 ...
	 */
	public void ubahElemen_2511531002(int index, String nilaiBaru) {
		data.set(index, nilaiBaru);
	}
	/**
	 * Menghapus elemen pada posisi 'index' dan mengembalikan nilai yang dihapus/
	 */
	public String hapusElemen_2511531002(int index) {
	 ...
	 */
	public void iterasiCetak_2511531002() {
